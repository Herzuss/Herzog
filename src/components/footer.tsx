...
export default function Footer() {
  return (
    <section className="border border-t-neutral-500 mt-5">
      <div className="max-w-screen-2xl mx-auto flex gap-5 lg:gap-0 flex-col lg:flex-row  justify-between items-center px-4 md:px-24 mt-5 mb-5">
        ...
        <div className="flex flex-row">
          <p className="text-base text-zinc-200 font-normal mx-auto ">
            © 2025 HERZOG
          </p>
        </div>
      </div>
